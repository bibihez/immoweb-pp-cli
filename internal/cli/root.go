...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "immoweb-pp-cli",
		Short: "Manage immoweb resources via the immoweb API",
		Long: `Manage immoweb resources via the immoweb API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'immoweb-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'immoweb-pp-cli profile list')")
