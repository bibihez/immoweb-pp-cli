...
Exit codes & warnings:
  ...
  immoweb-pp-cli sync --resources channels,messages
  ...
  immoweb-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/immoweb-pp-cli/data.db)")
