...
but do not stop the import.`,
  ...
  immoweb-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  immoweb-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | immoweb-pp-cli import <resource> --input -`,
